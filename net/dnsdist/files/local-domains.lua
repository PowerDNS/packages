...
function M.run(_)
  if M.destinations == nil or M.destinations:size() == 0 or M.lanSuffixes == nil or #M.lanSuffixes == 0 then
    return
  end
  ...
  local nmgRule = NetmaskGroupRule(M.destinations, false)
  addAction(AndRule{nmgRule, SuffixMatchNodeRule(lanSuffixesMatchNode)}, LuaFFIAction(lanaction))
end
